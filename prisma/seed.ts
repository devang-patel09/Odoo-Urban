import { PrismaClient, UserRole, ContactType, ProductType, AccountType, JournalType, AnalyticType, BudgetStatus, RecordStatus } from '@prisma/client';
...
async function main() {
  ...
  const accountsData = [
    ...
    { code: '1010', name: 'Bank Account - HDFC', type: AccountType.ASSET },
    { code: '1100', name: 'Debtors / Accounts Receivable', type: AccountType.ASSET },
    { code: '1200', name: 'Inventory / Stock A/c', type: AccountType.ASSET },
    { code: '2000', name: 'Creditors / Accounts Payable', type: AccountType.LIABILITY },
    { code: '2100', name: 'Output GST / Tax Payable', type: AccountType.LIABILITY },
    { code: '2110', name: 'Input GST / Tax Credit Paid', type: AccountType.ASSET },
    { code: '3000', name: 'Capital / Owner Equity', type: AccountType.EQUITY },
    { code: '4000', name: 'Sales Income', type: AccountType.INCOME },
    { code: '5000', name: 'Purchases Expense', type: AccountType.EXPENSE },
    { code: '5100', name: 'Operating Expenses', type: AccountType.EXPENSE },
    { code: '5200', name: 'Other Expenses', type: AccountType.OTHER_EXPENSE },
  ];
  ...
  const analyticsData = [
    { name: 'Furniture Operations', type: AnalyticType.EXPENSE },
    { name: 'Project 1', type: AnalyticType.EXPENSE },
    { name: 'Corporate Commercial Sales', type: AnalyticType.INCOME },
  ];
